...
public class AccViewModel extends BaseViewModel {
    ...
    public LiveData<List<AccelerationInformation>> getAccelerationData() {
        return getDatabase().getAccDao().getAcceleration();
    }
    ...
    private static final class AccelerationLiveData extends LiveData<AccelerationInformation> {
